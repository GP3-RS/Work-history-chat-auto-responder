...
export default [
  ...
  },
  {
    role: "assistant",
    content:
      "A couple of days- it was a lot of fun. It's basically just a Node/Express backend hosted for free on Cyclic. And each request only costs about $.01 so it's fine",
  },
  {
    role: "user",
